...
export default function ProjectItem({ img, name, content }) {
  return (
    <>
      <div className="relative flex flex-col bg-clip-border rounded-xl bg-transparent text-gray-700 shadow-none">
        ...
        <div className="p-0">
          ...
          >
            <h5 className="block antialiased tracking-normal font-sans text-xl font-bold leading-snug text-inherit mb-2">
              {name}
            </h5>
          </a>
